  ...
  return (
    <section className="w-full min-h-screen grid grid-cols-1 md:grid-cols-2 relative">
      <div className="col-span-3 md:col-span-1 p-10 lg:p-40 my-auto flex flex-col items-start px-2 w-4/5 mx-auto md:w-fit md:px-10">
        ...
        <div className="w-4/5 px-8 lg:px-0 lg:w-1/2">
          ...
          <a href="tel:+17806556096" className="block text-lg ">
            +1-780-655-6096
          </a>
        </div>
        <div className="w-4/5 px-8 lg:px-0 lg:w-1/2 flex gap-4 mt-8">
      ...
      <div className="flex flex-col justify-center items-center z-10 gap-4 lg:py-12">
