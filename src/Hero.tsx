...
function Hero() {
  return (
    <section className="w-full h-screen grid grid-cols-1 md:grid-cols-2 relative bg-gradient-to-t from-black to-transparent">
      <div className="bg-black mx-8 md:mx-16 my-auto z-10 rounded-xl border-gray-500 border py-4 px-8 shadow-2xl shadow-gray-700 text-3xl font-light leading-none font-mono">
        &gt; &nbsp;
